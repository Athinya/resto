...
router.register("BankDetails_tblalldatas", BankDetails_tablView, basename="BankDetails_tblalldatas")
router.register("Shoplogo_tblalldatas", shoplogoView, basename="Shoplogo_tblalldatas")
...
urlpatterns = [
    ...
    path('get-csrf-token/', views.send_csrf_token, name='get-csrf-token'),
    path('send-email-otp/', send_email_otp, name='send_email_otp'),
    path('send-forgotemail-otp/', send_Forgotemail_otp, name='send_forgotemail_otp'),
