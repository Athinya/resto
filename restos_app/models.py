...
class BankDetails_tabl(models.Model):
      cusid = models.CharField(max_length=50)
      ...
      upinumber = models.CharField(max_length=50)


      class Meta:
          db_table = 'BankDetails_tbl'

class shoplogo(models.Model):
      cusid = models.CharField(max_length=50)
      shoplogo = models.BinaryField(db_column="shoplogo",editable=True )

      class Meta:
          db_table = 'Shoplogo_tbl'
